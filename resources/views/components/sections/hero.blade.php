    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center z-10">
        ...
        <div :class="loaded ? 'animate-fade-in-up' : 'opacity-0'" class="flex flex-col items-center gap-8" style="animation-delay: 0.3s;">
            ...
            <div class="flex items-center justify-center sm:justify-start gap-6 mt-8 flex-wrap">
                ...
                <!-- GitHub (Gray) -->
                <a href="https://github.com/Error000000000" target="_blank" class="group relative w-16 h-16 rounded-xl p-[1px] bg-gradient-to-b from-gray-500 to-transparent hover:from-white transition-all duration-300 hover:-translate-y-1 shadow-lg shadow-black/50" title="GitHub">
